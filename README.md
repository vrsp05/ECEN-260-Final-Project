...
## 📌 Overview
This embedded systems project uses an **STM32 Nucleo-L476RG** microcontroller to measure and display the voltage and estimated charge percentage of common batteries (1.5V, 3V, and 9V). The system reads analog voltage through the ADC, displays results on an I2C LCD, and accepts user commands via UART.
